...
namespace nc
{
	...
	bool Texture::Load(const std::string& filename, Renderer& renderer)
	{
		...
		glTexParameteri(m_target, GL_TEXTURE_WRAP_S, GL_REPEAT); //use coordinates s and t. like u and v
		glTexParameteri(m_target, GL_TEXTURE_WRAP_T, GL_REPEAT); //mirrored_repeat, clamp_to_edge, repeat
